...
#    sample_path = tmpdir + "blast_files/" + sample + ".blast"

    call(["perl", "scripts/create_abundance_files.pl", sample + ".blast" , seq_no, tmpdir])
...
def blastn(fas, db):
    ...
    blast_in = (fas)
    blast_out = (tmpdir + "blast_files/" + sample + ".blastn")
